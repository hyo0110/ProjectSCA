...
<%-- 	<jsp:include page="/WEB-INF/views/navi.jsp"></jsp:include>	 --%>
	...
	<div class="card shadow mb-4">
		...
		<ul class="pagination">
			<li class="page-item"><a class="page-link" href="./admin_faqboard?page=1"><span>처음</span></a>
			...
			<li class="page-item"><a id="nextPage" class="page-link"
				href="./admin_faqboard?page=${currPage+1}" aria-label="Next"> <span
					aria-hidden="true">&raquo;</span> <span class="sr-only">Next</span>
			</a></c:if> 
			<a class="page-link" href="./admin_faqboard?page=${endPage}"><span>끝</span></a>
			</li>	
		</ul>
	</div>
	</div><!-- content -->
